    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col text-end">
                <a href="./addDept.php" class="btn btn-outline-success"><i class="fa-solid fa-plus"></i>&nbsp;Add Department</a>
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $department['dept_email'] ?></td>
                        <td><?php echo $department['dept_desc'] ?></td>
                        <td><?php echo $department['dept_remarks'] ?></td>
                        <td>
                            <a href="editDept.php?id=<?php echo $department['dept_id'] ?>" class="btn btn-primary text-light"><i class="fa-solid fa-pen-to-square"></i></a> &nbsp; 
                            <button class="btn btn-danger text-light delete" id="<?php echo $department['dept_id'] ?>"><i class="fa-solid fa-trash"></i></button>
                        </td>
                    </tr>
                    <?php $sr_no++; } ?>
                </tbody>
