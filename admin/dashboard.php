...
?>
    ...
    <div class="container-fluid px-5">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h6 class="card-title mb-3 text-left font-weight-bold" style="font-size: 30px; color: #003975;">Files Added</h6>
            ...
            <div class="col-lg-6">
                <h6 class="card-title mb-3 text-left font-weight-bold" style="font-size: 30px; color: #003975;">Files Status</h6>
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title text-center font-weight-bold" style="font-size: 60px; color: #003975;">
        ...
        <br>
        <div class="row">
            <h6 class="card-title mb-3 text-left font-weight-bold" style="font-size: 30px; color: #003975;">Office</h6>
